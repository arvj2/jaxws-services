 ...
 */
public class ServerSoapHandler1 implements SOAPHandler<SOAPMessageContext>{

    private static final String TAG = ServerSoapHandler1.class.getCanonicalName();
